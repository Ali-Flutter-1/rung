...
class AppLocalizationsDa extends AppLocalizations {
  ...
  @override
  String get profileOpenSettings => 'Åbn indstillinger';

  @override
  String get profileReminderFailed =>
      'Kunne ikke indstille påmindelsen. Tjek, at notifikationer er tilladt for Rung i telefonens indstillinger.';

  @override
  String get profileReminderSetTitle => 'Påmindelse indstillet 🪜';

  @override
  String profileReminderSetBody(String time) {
    return 'Vi giver dig et blidt puf kl. $time.';
  }
  ...
  String checkInStreakBanked(int count) {
    return 'Dag $count — i dag tæller, med eller uden et skridt.';
  }

  @override
  String get checkInDayBanked => 'I dag tæller. Det at møde op er pointen.';
  ...
  String get ppAnalyticsBody =>
      'Vi bruger privatlivsvenlig produktanalyse (PostHog) for at forstå, hvilke funktioner der hjælper – anonyme brugshændelser som “åbnede en skærm” eller “gennemførte et trin”, aldrig indholdet af dine noter eller beskeder. Den er slået fra som standard og kører kun, hvis du slår den til i Indstillinger; du kan slå den fra igen når som helst.';
  ...
  @override
  String get coachBusy => 'Coachen holder en lille pause – prøv igen om lidt.';
}
