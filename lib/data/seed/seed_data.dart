...
class SeedData {
  ...
  static const List<Rung> rungs = [
    ...
    Rung(id: 'rng_speaking_10', trackId: 'trk_speaking', difficulty: 10, sortOrder: 10, estMinutes: 10, title: 'Give a short prepared presentation', whatToDo: 'Deliver a few prepared minutes to a group.', whyItHelps: 'The top rung — proof of how far the ladder has carried you.'),
    ...
    Rung(id: 'rng_approaching_10', trackId: 'trk_approaching', difficulty: 10, sortOrder: 10, estMinutes: 5, title: 'Start a conversation with someone you find attractive', whatToDo: 'Open a friendly, no-agenda chat with someone you are drawn to.', whyItHelps: 'The top rung — high nerves, very survivable, great data.'),
    ...
    Rung(id: 'rng_social_events_10', trackId: 'trk_social_events', difficulty: 10, sortOrder: 10, estMinutes: 60, title: 'Host a small get-together', whatToDo: 'Invite a few people and run a simple plan.', whyItHelps: 'The top rung — you become the reason others gather.'),
    ...
    Rung(id: 'rng_assertiveness_10', trackId: 'trk_assertiveness', difficulty: 10, sortOrder: 10, estMinutes: 15, title: 'Negotiate something significant', whatToDo: 'Make a prepared case for a raise or something that matters.', whyItHelps: 'The top rung — advocacy for yourself, with real stakes.'),
    ...
    Rung(id: 'rng_visibility_10', trackId: 'trk_visibility', difficulty: 10, sortOrder: 10, estMinutes: 10, title: 'Perform or present where you are the focus', whatToDo: 'Put yourself center-stage in front of an audience.', whyItHelps: 'The top rung — fully seen, and still standing.'),
    ...
    Rung(id: 'rng_pressure_10', trackId: 'trk_pressure', difficulty: 10, sortOrder: 10, estMinutes: 15, title: 'Take on a timed, watched, high-stakes task', whatToDo: 'Take on something with a clock and an audience.', whyItHelps: 'The top rung — pressure, eyes, stakes, and you handling it.'),
  ];
}
